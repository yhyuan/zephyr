...
#define CLKEN_PA     CLKEN(APB2, PB)
//#define CLKEN_PA     {CK_APB2, RCU_APB2EN_PAEN}
#define CLKEN_PB     {CK_APB2, RCU_APB2EN_PBEN}
#define CLKEN_PC     {CK_APB2, RCU_APB2EN_PCEN}
#define CLKEN_PD     {CK_APB2, RCU_APB2EN_PDEN}
#define CLKEN_PE     {CK_APB2, RCU_APB2EN_PEEN}
#define CLKEN_USART0 {CK_APB2, RCU_APB2EN_USART0EN}
#define CLKEN_USART1 {CK_APB1, RCU_APB1EN_USART1EN}
#define CLKEN_USART2 {CK_APB1, RCU_APB1EN_USART2EN}
#define CLKEN_UART3  {CK_APB1, RCU_APB1EN_UART3EN}
#define CLKEN_UART4  {CK_APB1, RCU_APB1EN_UART4EN}
#define CLKEN_I2C0   {CK_APB1, RCU_APB1EN_I2C0EN}
#define CLKEN_I2C1   {CK_APB1, RCU_APB1EN_I2C1EN}
#define CLKEN_SPI0   {CK_APB2, RCU_APB2EN_SPI0EN}
#define CLKEN_SPI1   {CK_APB1, RCU_APB1EN_SPI1EN}
#define CLKEN_SPI2   {CK_APB1, RCU_APB1EN_SPI2EN}
#define CLKEN_CAN0   {CK_APB1, RCU_APB1EN_CAN0EN}
#define CLKEN_CAN1   {CK_APB1, RCU_APB1EN_CAN1EN}
